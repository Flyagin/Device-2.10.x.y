...
uint32_t choose_tn1_tn2(unsigned int*);
void avr_handler(unsigned int*, unsigned int);
void ctrl_phase_handler(unsigned int*, unsigned int);
...
unsigned int Get_data(unsigned char *, unsigned int, unsigned int, __getting_data);
unsigned int Set_data(unsigned short int, unsigned int, __settings_data, unsigned int, unsigned int*, unsigned int);
...
unsigned int convert_order_list_inputs_to_gmm(unsigned int, unsigned int, __getting_data);
unsigned int convert_order_list_oldr_to_gmm(unsigned int, unsigned int, unsigned int, __getting_data);
unsigned int convert_order_list_buttons_to_gmm(unsigned int, unsigned int, unsigned int, unsigned int, __getting_data);
void set_previous_ranguvannja(void);
unsigned int save_new_rang_inputs_from_gmm(unsigned int, unsigned int, unsigned short int, __settings_data);
unsigned int save_new_rang_oldr_from_gmm(unsigned int, unsigned int, unsigned int, unsigned short int, __settings_data);
unsigned int save_new_rang_buttons_from_gmm(unsigned int, unsigned int, unsigned short int, __settings_data);
