...
extern unsigned int mtz_prysk_tmr_const[2][NUMBER_LEVEL_TMR_MTZ_PRYSK_CONST];
extern unsigned int mtz_const_menu_settings_prt[NUMBER_LEVEL_MTZ][MTZ_CONST_MENU_SETTINGS_LENGTH];
extern unsigned int mtz_prysk_const_menu_settings_prt[2][MTZ_PR_CONST_MENU_SETTINGS_LENGTH];
...
extern int * timeout_mtz_prysk[2];
extern int * timeout_mtz_n_vpered[NUMBER_LEVEL_MTZ];
extern int * timeout_mtz_n_vpered_prysk[2];
extern int * timeout_mtz_n_nazad[NUMBER_LEVEL_MTZ];
extern int * timeout_mtz_n_nazad_prysk[2];
extern int * timeout_mtz_po_napruzi[NUMBER_LEVEL_MTZ];
extern int * timeout_mtz_po_napruzi_prysk[2];
extern int * timeout_mtz_vvid_prysk[2];
