...
//  target_label->number_defined_not = NUMBER_DEFINED_NOT_MAX;
  ...
  for (unsigned int i = 0; i < NUMBER_GROUP_USTAVOK; i++)
  {
    ...
    target_label->setpoint_avr_tn1_U1_min[i] = SETPOINT_AVR_TN1_U1_MIN_MIN;
    target_label->setpoint_avr_tn1_U2_low_work[i] = SETPOINT_AVR_TN1_U2_LOW_WORK_MAX;
    target_label->setpoint_avr_tn2_U2_min[i] = SETPOINT_AVR_TN2_U2_MIN_MIN;
    target_label->setpoint_avr_tn2_U1_low_work[i] = SETPOINT_AVR1_TN2_U1_LOW_WORK_MAX;
    target_label->setpoint_avr_tn1_U1_max[i] = SETPOINT_AVR_TN1_U1_MAX_MIN;
    target_label->setpoint_avr_tn1_U2_high_work[i] = SETPOINT_AVR1_TN1_U2_HIGH_WORK_MAX;
    target_label->setpoint_avr_tn2_U2_max[i] = SETPOINT_AVR_TN2_U2_MAX_MIN;
    target_label->setpoint_avr_tn2_U1_high_work[i] = SETPOINT_AVR1_TN2_U1_HIGH_WORK_MAX;
